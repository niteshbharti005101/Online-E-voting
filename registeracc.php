...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="index.html">Registration Panel</a></h1>
    </div>
    <!-- ################################################################################################ -->
...
<div  >
  <?php
  	...
  	if (isset($_POST['submit']))
  	{
  		...
  		$sql = mysqli_query($con,"INSERT INTO members(first_name, last_name, email, voter_id, password) VALUES ('$myFirstName','$myLastName', '$myEmail','$myVoterid', '$newpass')" ) or die( mysqli_error() );
